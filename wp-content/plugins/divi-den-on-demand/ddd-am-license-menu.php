...
if ( ! class_exists( 'ddd_AM_License_Menu' ) ) {
	class ddd_AM_License_Menu {
		...
		public function __construct( $file, $software_title, $software_version, $plugin_or_theme, $api_url, $text_domain, $extra ) {
			...
			if ( is_admin() ) {
				...
				$this->ame_settings_menu_title         = $this->software_title." (beta)";
    ...
    */
    ...
    public function report_data($warning_flag) {
        ...
        if((int)str_replace(".", "",PHP_VERSION) >= 52) $ddd_php_status = $ddd_ok_status;
        ...
        if((int)str_replace("M", "",ini_get( 'post_max_size' )) >= 64) $ddd_post_max_size_status = $ddd_ok_status;
        ...
        $report_table .= '<tr><td>max_input_time</td><td>600+</td><td>'.ini_get( 'max_input_time' ).'</td>';
        if((int)ini_get( 'max_input_time') >= 600) $ddd_max_input_time_status = $ddd_ok_status;
    ...
    public function ddd_getting_started() {
    	...
    	$ddd_starting .='"><!-- .et_pb_on_state || .et_pb_off_state -->
            ...
            if ($ddd_option_template == 'enabled') { $ddd_starting .= '<iframe id="ondemanIframe" name="ondemandIframe" class="settingsIframe" src="https://ondemand.divi-den.com/search-everything/?_sft_post_tag=free"></iframe><div class="loaded_message"><h3 class="sectionSaved">Success! Saved to Divi Library<br>The layout or section has been saved to your Divi Library.<br>Use the "Add From Library" tab in Divi Builder to load it onto a new page.</h3><span class="close">&#x2715;</span><div>'; }
            return $ddd_starting;
    }
    ...
    public function ddd_pro() {
        add_option( 'ddd_enable', 'enabled' );
        $ddd_pro = '';
        $ddd_pro .= '<iframe id="ondemanIframe" name="ondemandIframe" class="settingsIframe" src="https://ondemand.divi-den.com/search-everything/?_sft_post_tag=pro"></iframe><div class="loaded_message"><h3 class="sectionSaved">Success! Saved to Divi Library<br>The layout or section has been saved to your Divi Library.<br>Use the "Add From Library" tab in Divi Builder to load it onto a new page.</h3><span class="close">&#x2715;</span><div>';
            return $ddd_pro;
    }

    public function ddd_assistant_help_faq() {
    	$ddd_help_faq = '<a class="et-core-modal-action" target="_blank" href="https://seku.re/ondemand-kb">Browse Knowledge Base</a>
            <br/>
            <h3>Submit your feedback</h3><iframe id="supportIframe" src="https://divi-den.com/divi-den-support-for-plugins-iframe?systemreport='.$GLOBALS['$report_for_email'].'"/></iframe>';
	...
	public function config_page() {
		$this->report_data($warning_flag = 1);
			$settings_tabs = array( 
                ...
                'ddd_assistant_pro' => 'Pro Layouts', 
				'ddd_assistant_system_status' => 'System Status / Troubleshooting',
				'ddd_assistant_help_faq' => 'Give Beta Plugin Feedback'
			);
